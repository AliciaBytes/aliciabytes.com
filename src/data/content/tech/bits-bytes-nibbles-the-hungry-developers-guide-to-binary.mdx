...
<PictureFigure src="https://www-cdn.aliciabytes.com/file/aliciabytes-com/pages/bits-bytes-nibbles-the-hungry-developers-guide-to-binary/rock-on.png" caption="Showing from right to left: 2 fingers extended, 2 fingers hidden, 1 finger extended" formats={['avif', 'webp']} fallbackFormat="jpg" width="1200" height="1200" quality="mid" />
